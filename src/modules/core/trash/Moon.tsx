import THREE, { AdditiveBlending, BackSide, DoubleSide, Euler, Group, Mesh, Object3D, Texture, Vector3 } from "three";
...
export default function Body({
    ...
    useFrame(async (state: RootState, timeDelta: number, frame: any) => {
        ...
        var cloudAnim = new Vector3(alpha, (offSet * 0.75) * beta, gamma * 1);
